...
data class Movie(
    ...
    val country: String? = null, val language: String? = null, val region: String? = null,
    @SerializedName("disc_count") val discCount: Int? = null, val status: String = "owned", val notes: String? = null,
    @SerializedName("parent_box_set_id") val parentBoxSetId: Int? = null,
    @SerializedName("parent_box_set_name") val parentBoxSetName: String? = null,
    @SerializedName("loan_state") val loanState: String = "available"
) {
...
data class ShelfMoviesResponse(val shelf: Shelf, val movies: List<Movie>)
...
data class LoanMovieRequest(
    val borrower: String,
    val phone: String? = null,
    @SerializedName("loaned_date") val loanedDate: String? = null,
...
data class CollectionItem(
    val id: Int, @SerializedName("library_id") val libraryId: Int, val name: String,
    val description: String = "", @SerializedName("movie_count") val movieCount: Int = 0
)
data class CollectionsResponse(val collections: List<CollectionItem>)
data class Loan(
    val id: Int, @SerializedName("library_id") val libraryId: Int, @SerializedName("movie_id") val movieId: Int,
    val title: String, val borrower: String, val phone: String = "",
    @SerializedName("loaned_at") val loanedAt: String, @SerializedName("returned_at") val returnedAt: String?, val notes: String
)
...
interface HomebusterApi {
    ...
    @GET("api/v1/shelves/{id}/movies") suspend fun shelfMovies(@Header("Authorization") auth: String, @Path("id") id: Int): ShelfMoviesResponse
