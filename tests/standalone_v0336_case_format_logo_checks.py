...
assert any(v in config for v in ('APP_VERSION = "0.3.73"','APP_VERSION = "0.3.73"', 'APP_VERSION = "0.3.73"', 'APP_VERSION = "0.3.73"', 'APP_VERSION = "0.3.73"', 'APP_VERSION = "0.3.73"')), 'server version not bumped'
