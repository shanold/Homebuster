...
assert any(v in config for v in ('APP_VERSION = "0.3.71"','APP_VERSION = "0.3.71"', 'APP_VERSION = "0.3.71"', 'APP_VERSION = "0.3.71"', 'APP_VERSION = "0.3.71"', 'APP_VERSION = "0.3.71"')), 'server version not bumped'
