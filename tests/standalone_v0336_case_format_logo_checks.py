...
assert any(v in config for v in ('APP_VERSION = "0.3.36"','APP_VERSION = "0.3.37"', 'APP_VERSION = "0.3.38"', 'APP_VERSION = "0.3.39"', 'APP_VERSION = "0.3.40"')), 'server version not bumped'
