...
assert any(v in config for v in ('APP_VERSION = "0.3.67"','APP_VERSION = "0.3.67"', 'APP_VERSION = "0.3.67"', 'APP_VERSION = "0.3.67"', 'APP_VERSION = "0.3.67"', 'APP_VERSION = "0.3.67"')), 'server version not bumped'
