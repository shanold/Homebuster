...
assert any(v in config for v in ('APP_VERSION = "0.3.70"','APP_VERSION = "0.3.70"', 'APP_VERSION = "0.3.70"', 'APP_VERSION = "0.3.70"', 'APP_VERSION = "0.3.70"', 'APP_VERSION = "0.3.70"')), 'server version not bumped'
