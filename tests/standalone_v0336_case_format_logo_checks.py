...
assert any(v in config for v in ('APP_VERSION = "0.3.72"','APP_VERSION = "0.3.72"', 'APP_VERSION = "0.3.72"', 'APP_VERSION = "0.3.72"', 'APP_VERSION = "0.3.72"', 'APP_VERSION = "0.3.72"')), 'server version not bumped'
