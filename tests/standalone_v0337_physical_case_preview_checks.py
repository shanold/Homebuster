...
assert any(v in config for v in ('APP_VERSION = "0.3.65"', 'APP_VERSION = "0.3.65"', 'APP_VERSION = "0.3.65"', 'APP_VERSION = "0.3.65"', 'APP_VERSION = "0.3.65"')), 'server version not bumped'
