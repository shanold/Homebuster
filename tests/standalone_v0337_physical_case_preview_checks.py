...
assert any(v in config for v in ('APP_VERSION = "0.3.66"', 'APP_VERSION = "0.3.66"', 'APP_VERSION = "0.3.66"', 'APP_VERSION = "0.3.66"', 'APP_VERSION = "0.3.66"')), 'server version not bumped'
