...
assert any(v in config for v in ('APP_VERSION = "0.3.68"', 'APP_VERSION = "0.3.68"', 'APP_VERSION = "0.3.68"', 'APP_VERSION = "0.3.68"', 'APP_VERSION = "0.3.68"')), 'server version not bumped'
