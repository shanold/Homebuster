...
assert any(v in config for v in ('APP_VERSION = "0.3.69"', 'APP_VERSION = "0.3.69"', 'APP_VERSION = "0.3.69"', 'APP_VERSION = "0.3.69"', 'APP_VERSION = "0.3.69"')), 'server version not bumped'
